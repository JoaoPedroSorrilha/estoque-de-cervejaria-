...
Aprendemos a testar, unitariamente, uma API REST para o gerenciamento de estoques de cerveja. 
Desenvolvemos testes unitários para validar o nosso sistema de gerenciamento de estoques de cerveja.
Foram apresentados os principais conceitos e vantagens de criar testes unitários com JUnit e Mockito. 
Também foi mostrado como desenvolver funcionalidades da nossa API através da prática do TDD.
...
```
http://localhost:8080/api/v1/biere
```
